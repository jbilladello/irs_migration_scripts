# This script works with CSV files for State-level IRS migration data from the years 2013 - 2014 and on.
...
# and then input the full path to the State Inflow file, followed by the full path to the State Outflow file.
...
#--inflow--#
    ...
    with open(input('Enter path with name of the State Inflow file: ')) as states:     
            newlist_in = []
            newlist_totals = []
...
#--outflow--#
    with open(input('Enter path with name of the State Outflow file: ')) as states:
        newlist_out = []
        newlist_totals_out = []
